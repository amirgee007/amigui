...
(function (factory) {
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    uploadIcon: '<i class="fa fa-download"></i>',
                    uploadClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
                    uploadTitle: 'Make Favorite image',
                    uploadRetryIcon: '<i class="fa fa-repeat"></i>',
                    uploadRetryTitle: 'Retry upload',
                    downloadIcon: '<i class="fa fa-download"></i>',
                    downloadClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
                    downloadTitle: 'Make Favourite image',
                    ...
                    dragSettings: {},
                    indicatorNew: '<i class="fa fa-plus-square text-warning"></i>',
                    indicatorSuccess: '<i class="fa fa-thumbs-o-up text-success"></i>',
                    indicatorError: '<i class="fa fa-exclamation text-danger"></i>',
                    indicatorLoading: '<i class="fa fa-glass text-muted"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            ...
            toggleheader: '<i class="fa  fa-random"></i>',
